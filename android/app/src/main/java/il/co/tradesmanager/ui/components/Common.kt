...
/**
 * A section heading with the button that fills that section.
 *
...
/** What a section says when it is empty but still worth showing. */
@Composable
fun SectionPlaceholder(text: String) {
    Text(
        text = text,

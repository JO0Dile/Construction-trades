...
- 22 trades, **527 catalogue items**, 193 safety checks and 17 project
  ...
  rejected
- **1,355 interface strings and 18 plural rules in Hebrew, Arabic and
...
- a Room data layer: **56 entities, 32 migrations** replayed end to end on
...
- the five lenses as Compose screens. The SwiftUI app covers the first
  ...
  the 56 Android tables, and everything built since (money, people, the site
...
- **715 unit tests, all passing**, and a release bundle built through R8 on
